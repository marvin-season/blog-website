...
export default function useVirtualScroll<T>(
        ...
        (dom: HTMLDivElement) => {
            if (dom) {
                ...
                if (
                    ...
                    console.log(
                        "scroll",
                        dom.clientHeight * acceleration,
                        dom.clientHeight,
                    );
                    const target = dom.parentElement.children.item(
                        acceleration + 1,
                    );
                    let top = 0;
                    if (target) {
                        ...
                        top =
                            dom.clientHeight * acceleration +
                            topTargetRef.current.clientHeight;
                    }
